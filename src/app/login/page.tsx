  ...
  return (
    <div className="flex flex-col min-h-screen bg-white">
        ...
        <div className="w-full max-w-sm space-y-10 animate-in fade-in slide-in-from-bottom-8 duration-700">
          <div className="text-center space-y-6">
            ...
            <div className="space-y-2">
              ...
              <p className="text-[10px] text-gray-400 font-bold uppercase tracking-[0.2em]">Access your team terminal</p>
            </div>
          </div>
          ...
          <form className="space-y-6" onSubmit={handleLogin}>
            <div className="space-y-4">
              ...
              <div className="group">
                <label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1 mb-1.5 block group-focus-within:text-[#2563EB] transition-colors">Security Code</label>
                <div className="relative">
            ...
            >
              {loading ? "INITIALIZING..." : "SIGN IN TO PORTAL"}
            </button>
          </form>

          <p className="text-center text-[10px] font-black text-gray-400 uppercase tracking-widest">
            New to TeamWave?{" "}
            <a href="/signup" className="text-[#2563EB] border-b border-blue-100 hover:border-blue-500 transition-all">
              Request Access
            </a>
          </p>
        </div>
      ...
      <footer className="p-8 text-center">
         <p className="text-[10px] text-gray-300 font-bold uppercase tracking-widest">TeamWave Security Protocol v2.4.0</p>
      </footer>
    </div>
  );
}
